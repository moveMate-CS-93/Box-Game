...
{
  public class BoxHandTrackingConfig : ModalContents
  {
    ...
    private BoxHandTrackingSolution _solution;
    ...
    private void Start()
    {
      _solution = GameObject.Find("Solution").GetComponent<BoxHandTrackingSolution>();
      InitializeContents();
    }
    ...
    {
      _solution.modelComplexity = (BoxHandTrackingGraph.ModelComplexity)_modelComplexityInput.value;
      _isChanged = true;
    }
    ...
    private void InitializeModelComplexity()
    {
      ...
      var options = new List<string>(Enum.GetNames(typeof(BoxHandTrackingGraph.ModelComplexity)));
